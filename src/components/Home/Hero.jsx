...
const Hero = () => {
    return (
        <section className="relative w-full min-h-[90vh] md:min-h-screen flex flex-col pt-24 md:pt-32 px-6 md:px-0 bg-transparent">
            <div className="container mx-auto flex flex-col flex-grow relative z-10 w-full max-w-[1440px]">
                <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-10 lg:gap-8 w-full flex-grow py-10 md:py-16">
                    <div className="flex flex-col justify-start">
                        ...
                        <h1 className="font-serif text-[42px] md:text-[60px] lg:text-[76px] xl:text-[92px] leading-[0.95] text-white mt-10 md:mt-12 tracking-tight">
                            Building Leaders – <br />
                            <span className="italic text-white/30 font-serif lowercase">the</span> World Can Trust.
                        </h1>
                    </div>
                    <div className="flex flex-col justify-end lg:pb-32">
                        <p className="font-sans text-[18px] leading-[1.55] text-white/80 max-w-[540px] lg:text-right lg:ml-auto">
                ...
                <div className="absolute bottom-10 left-0 w-full border-t-[0.5px] border-white/20 pt-6 flex justify-between items-center text-white/70 font-sans text-[10px] md:text-xs tracking-[0.1em] uppercase">
