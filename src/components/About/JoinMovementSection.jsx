...
const JoinMovementSection = () => {
    ...
    return (
        <section ref={containerRef} className="relative w-full py-16 md:py-32 px-4 md:px-8 flex flex-col items-center justify-center text-center bg-bg-dark">
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
                ...
                <button onClick={() => window.open('https://calendly.com/lmartinich/', '_blank')} className="join-animate group bg-[#006AFF] text-white font-sans font-bold py-4 px-8 flex items-center gap-3 cursor-pointer">
                    Join the Movement
