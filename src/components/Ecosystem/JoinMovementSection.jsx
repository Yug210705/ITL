    ...
    return (
        <section ref={containerRef} className="relative w-full py-12 md:py-20 lg:py-24 px-6 md:px-12 flex flex-col items-center justify-center text-center bg-transparent overflow-hidden">
            <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
                ...
                <h2 className="join-reveal font-serif text-[32px] md:text-[52px] lg:text-[68px] text-white leading-[1.1] mb-8 md:mb-10 max-w-3xl">
                    Be Part of Building Leadership <br className="hidden md:block" />
                    the World Can Trust
                </h2>

                <p className="join-reveal font-sans text-white/40 text-[16px] md:text-[20px] leading-relaxed mb-12 md:mb-16 max-w-2xl">
                    Whether you are an individual, an organization, or a collaborator, meaningful change begins with a conversation.
                </p>

                <button onClick={() => window.open('https://calendly.com/lmartinich/', '_blank')} className="join-reveal group bg-[#0052FF] hover:bg-[#0047E0] text-white font-sans font-bold py-5 px-10 flex items-center gap-4 transition-all duration-300 rounded-sm shadow-[0_0_30px_rgba(0,82,255,0.4)]">
